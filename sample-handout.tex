...
\usepackage{csquotes} % automatic environemt for quotes respecting language and depth
...
\usepackage{fontspec}
\setmainfont[Mapping=tex-text,Numbers=OldStyle]{Work Sans}[
BoldFont={* SemiBold},
]
...
\newfontfamily{\FontA}{FontAwesome} 
